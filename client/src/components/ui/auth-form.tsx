...
const AuthForm: React.FC = () => {
    return (
        <div className="bg-white dark:bg-zinc-950 py-20 text-zinc-800 dark:text-zinc-200 selection:bg-zinc-300 dark:selection:bg-zinc-600 min-h-screen relative overflow-hidden">
            <BackButton />
            <motion.div
...
const Logo: React.FC = () => (
    <div className="mb-6 flex justify-center items-center">
        ...
        <span className="ml-2 text-2xl font-black tracking-tighter">BLOCK<span className="text-blue-600">TIX</span></span>
    </div>
)
