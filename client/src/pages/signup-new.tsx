    ...
    try {
      ...
      if (data.user) {
        ...
        toast({
          ...
          description: "Your organizer account has been successfully created. Please check your email to verify your account.",
          duration: 5000
        });
          ...
          <CardContent className="space-y-5 pt-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-12 h-12 bg-slate-800/50 border-slate-700/50 text-white placeholder:text-slate-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all ${
            ...
            <div className="text-center">
              <Button
                ...
                variant="outline"
                className="w-full h-12 border-2 border-slate-700/50 hover:border-blue-500/50 hover:bg-blue-500/10 text-slate-300 hover:text-blue-300 font-semibold transition-all"
              >
